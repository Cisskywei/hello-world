...
namespace UMP
{
    public class PlayerOptions
    {
        ...
        public Vector2 FixedVideoSize
        {
            get
            {
                int width = GetValue<int>(FIXED_SIZE_WIDTH_KEY);
                int height = GetValue<int>(FIXED_SIZE_HEIGHT_KEY);
            ...
            set
            {
                SetValue(FIXED_SIZE_WIDTH_KEY, value.x.ToString());
                SetValue(FIXED_SIZE_HEIGHT_KEY, value.y.ToString());
            }
        }
