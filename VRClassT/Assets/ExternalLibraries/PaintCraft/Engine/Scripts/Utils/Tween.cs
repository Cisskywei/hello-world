...
namespace PaintCraft.Utils{
    /// <summary>
    /// Tween type.
    /// origin http://wiki.unity3d.com/index.php?title=Tween
    /// movement types http://stackoverflow.com/questions/5161465/how-to-create-custom-easing-function-with-core-animation
    /// </summary>
    ...
    public static class Tween {
        ...
        * Easing equation float for a cubic (t^3) easing out/in: deceleration until halfway, then acceleration.
        ...
        public static Vector3 ChangeVector(float t , Vector3 b , Vector3 c , float d , TweenType tweenType)
        {
            float x = methods[(int)tweenType](t, b.x, c.x,d);
            float y = methods[(int)tweenType](t, b.y, c.y,d);
            float z = methods[(int)tweenType](t, b.z, c.z,d);
         ...
         * @return      The correct value.
         */
        public static float ChangeFloat(float t , float b , float c , float d , TweenType tweenType)
        {
            return methods[(int)tweenType](t,b,c,d);
        }
    }
}