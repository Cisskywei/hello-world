...
namespace UMP
{
    ...
    public class PlayerManagerEvents
    {
        ...
        public void CopyPlayerEvents(PlayerManagerEvents events)
        {
            ...
            PlayerOpeningListener += events._playerOpeningListener;
            PlayerBufferingListener += events._playerBufferingListener;
            PlayerPreparedListener += events._playerPreparedListener;
            PlayerPlayingListener += events._playerOpeningListener;
            PlayerPausedListener += events._playerPausedListener;
            PlayerStoppedListener += events._playerStoppedListener;
            PlayerEndReachedListener += events._playerEndReachedListener;
            PlayerEncounteredErrorListener += events._playerEncounteredErrorListener;
            PlayerTimeChangedListener += events._playerTimeChangedListener;
            PlayerPositionChangedListener += events._playerPositionChangedListener;
            PlayerSnapshotTakenListener += events._playerSnapshotTakenListener;
        }
