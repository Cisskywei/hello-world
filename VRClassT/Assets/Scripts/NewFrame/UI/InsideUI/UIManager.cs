...
public class UIManager : MonoBehaviour {
    ...
    public enum TeacherUIRight
    {
        None = -1,
        MsgTips,
    }

    public enum StudentUILeft
    {
        None = -1,
    ...
    public OutUIBase[] teacherui;
    public OutUIBase[] studentui;
