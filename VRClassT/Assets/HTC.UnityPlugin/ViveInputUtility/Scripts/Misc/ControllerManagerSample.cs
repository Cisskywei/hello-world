...
public class ControllerManagerSample : MonoBehaviour
{
    ...
    {
        get { return true; /*!m_rightLaserPointerActive && !m_rightCurvePointerActive && !m_rightCustomModelActive; */}
    }
    ...
    {
        get { return true; /*!m_leftLaserPointerActive && !m_leftCurvePointerActive && !m_leftCustomModelActive;*/ }
    }
    ...
    public void UpdateActivity()
    {
        ...
        var rightGraggerShouldActive = true; //!m_rightLaserPointerActive && !m_rightCustomModelActive && !m_rightCurvePointerActive;
        ...
        var leftGraggerShouldActive = true;// !m_leftLaserPointerActive && !m_leftCustomModelActive && !m_leftCurvePointerActive;
